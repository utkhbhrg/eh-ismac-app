...
export class SyscheckRequest {
   ...
   */
  async top3agents(gte, lte, filters, pattern = 'EH-Alerts-*') {
    try {
      const base = {};
   ...
   * @returns {Array<String>}
   */
  async top3Rules(gte, lte, filters, pattern = 'EH-Alerts-*') {
    try {
      const base = {};
  ...
  async lastTenDeletedFiles(gte, lte, filters, pattern = 'EH-Alerts-*') {
    try {
      const base = {};
